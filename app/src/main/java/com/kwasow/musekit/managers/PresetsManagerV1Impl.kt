...
import com.kwasow.musekit.data.PresetV1
import java.io.File

class PresetsManagerV1Impl(
    ...
    // ====== Public methods
    fun savePreset(preset: PresetV1) {
    ...
    fun getPresets(): List<PresetV1> {
        val directory = File(context.filesDir, PRESET_DIR)
        val presets = mutableListOf<PresetV1>()
